...
boxes.forEach(box => {
  box.addEventListener('click', () => {
    ...
    btnText.innerHTML = `<a target="_blank" href="https://wa.me/+916005156100?text=Salamun Alikum I Want *${cartHeader.innerText}* book of *_${cartDescription.innerText}_* from your website https://idarahwaliulasr.netlify.app/library .Let me know when and how this would be available."><svg width="15" height="16" xmlns="http://www.w3.org/2000/svg">
